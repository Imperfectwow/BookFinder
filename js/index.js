$(document).ready(function () {
  ...
  function displayResults(response) {
    for (let i = 0; i < response.items.length; i += 2) {
      ...
      outputList.innerHTML +=
        '<div class="row mt-4">' +
        formatOutput(bookImg1, title1, description1, bookIsbn) +
        formatOutput(bookImg2, title2, description2, bookIsbn2) +
        "</div>";
    }
  }
   ...
   * @return htmlCard
   */
  function formatOutput(bookImg, title, description, bookIsbn) {
